...
fun HistoryScreen(
    ...
    val rideHistoryState by viewModel.rideHistoryState.observeAsState(NetworkResult.Loading)
    ...
    Column(
        ...
        // State display area
        NetworkResultDisplay(result = rideHistoryState)

        Spacer(Modifier.height(24.dp))

        // Get Ride History button
        Button(
            onClick = { viewModel.fetchRideHistory() },
            modifier = Modifier.fillMaxWidth(),
            enabled = rideHistoryState !is NetworkResult.Loading
        ) {
